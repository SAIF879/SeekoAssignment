...
import com.example.seekoassignment.SeekoApplication
...
class OkHttpClientHelper {
    ...
    fun getOkHttpClient(): OkHttpClient {
        val httpCacheDirectory = File(SeekoApplication.instance?.cacheDir, "http-cache")
    ...
    private fun getChuckerInterceptor(): ChuckerInterceptor? {
        ...
        val context = SeekoApplication.instance
        return context?.let {
